...
import { CapasTematicas, ItemResponseTablaContenido, TablaDeContenidoInterface, Tematicas, TematicasCapasBisnietos, datosBasicosInterface, interfaceCapasNietos } from "../types/interfaces";
