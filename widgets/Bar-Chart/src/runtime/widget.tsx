...
import { LabelItem } from '../../../searchSIEC/src/runtime/widget'
 ...
 const prepareBarChartData = (features: any[], labels: LabelItem[]) => {
  ...
  return (
    <div style={{height:'100%', width:'100%', alignContent:'center'}}>
      <div className='w-100 p-3 bg-primary' style={{height:'-webkit-fill-available', display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}}>      
        ...
        <>
                {
                  (dataGrafico.length > 0/*  && poligonoSeleccionado.departmentSelect */) && (
                    <div style={{ padding: '10px', width: '100%', height: '100%', border: 'solid', borderRadius: '10px',
